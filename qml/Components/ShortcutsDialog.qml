        ...
        return [
            ...
            },
            {
                ...
                items: [
                    ...
                    { keys: "Shift+Left", action: qsTr("Move selection right to left") },
                    { keys: "Shift+Right", action: qsTr("Move selection left to right") },
                    ...
                    { keys: "Shift+Up / Shift+Down / Shift+Home / Shift+End", action: qsTr("Extend selection range") },
