...
function scriptDefinition() {
    return {
        name: "ComfyDownscale2",
        description: "Downscale selected images 2x with ComfyUI, replacing the originals.",
        controls: [
            {
                id: "serverUrl",
                type: "text",
        ...
        run: function(params, selection) {
            ...
            const workflowPath = (baseDir ? baseDir + "/" : "") + "ComfyDownscale2.json"
